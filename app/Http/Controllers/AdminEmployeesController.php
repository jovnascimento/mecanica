<?php namespace App\Http\Controllers;
	...
	class AdminEmployeesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Estado','name'=>'state','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'AC;AL;AP;AM;BA;CE;DF;ES;GO;MA;MT;MS;MG;PA;PB;PR;PE;PI;RJ;RN;RS;RO;RR;SC;SP;SE;TO'];
			$this->form[] = ['label'=>'CEP','name'=>'zip','type'=>'text','validation'=>'required|min:9|max:9','width'=>'col-sm-10','help'=>'Digite no formato XXXXX-XXX'];
			$this->form[] = ['label'=>'Data de Nascimento','name'=>'birth_date','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'E-mail','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:employees','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			$this->form[] = ['label'=>'Telefone','name'=>'phone','type'=>'number','validation'=>'required|numeric','width'=>'col-sm-10','help'=>'Digite o telefone sem o 0 do DDD e somente com números'];
			$this->form[] = ['label'=>'Especialidade','name'=>'role','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Administrador;Mecânico'];
