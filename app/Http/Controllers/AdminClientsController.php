<?php namespace App\Http\Controllers;
	...
	class AdminClientsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'E-mail','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:clients','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
